...
class MoroccanCitiesService {
  ...
  static final List<MoroccanCity> _moroccanCities = [
    MoroccanCity(
      ...
      description: 'Capital économique du Maroc',
      images: [
      ...
      landmarks: ['Mosquée Hassan II', 'Corniche', 'Morocco Mall', 'Ancienne Médina'],
      latitude: 33.5731,
      longitude: -7.5898,
    ),
    MoroccanCity(
      ...
      description: 'La ville rouge aux mille couleurs',
      images: [
      ...
      landmarks: ['Jemaa el-Fna', 'Mosquée Koutoubia', 'Jardin Majorelle', 'Bahia Palace'],
      latitude: 31.6295,
      longitude: -7.9811,
    ),
    MoroccanCity(
      ...
      arabicName: 'فاس',
      region: 'Fès-Meknès',
      description: 'Ville impériale et spirituelle',
      images: [
      ...
      landmarks: ['Médina de Fès', 'Université Al Quaraouiyine', 'Madrasa Bou Inania', 'Tanneries'],
      latitude: 34.0331,
      longitude: -5.0003,
    ),
    MoroccanCity(
