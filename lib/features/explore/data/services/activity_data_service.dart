...
class ActivityDataService {
  static final List<ActivityModel> _sampleActivities = [
    // Activités spécifiques à Casablanca
    ActivityModel(
      id: 1001,
      nom: "Mosquée Hassan II",
      description: "Visitez l'impressionnante Mosquée Hassan II au bord de l'océan, chef‑d'œuvre de l'architecture marocaine.",
      prix: 120.0,
    ...
    ActivityModel(
      ...
      description: "Balade dans le quartier traditionnel des Habous, artisanat et ruelles au charme unique.",
      prix: 0.0,
    ...
    ActivityModel(
      id: 1003,
      nom: "Corniche d'Aïn Diab",
      description: "Promenade sur la corniche : plage, cafés et coucher de soleil sur l'Atlantique.",
      prix: 0.0,
    ...
    ActivityModel(
      id: 1004,
      nom: "Parc de la Ligue Arabe",
      description: "Grand parc urbain idéal pour se détendre au cœur de Casablanca.",
      prix: 0.0,
      imageUrl: "images/activities/cultural_heritage.jpg",
      dureeMinimun: 45,
      dureeMaximun: 120,
